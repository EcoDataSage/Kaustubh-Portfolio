  ...
  const experiences = [
    {
      ...
      highlights: [
        ...
        "Engineered and optimized semantic data models, ensuring efficient query performance through advanced calculation logic (DAX/MDX) and model tuning.",
        ...
        "Directed the end-to-end BI/analytics project lifecycle, encompassing requirements engineering, data modeling, ETL/ELT workflows, dashboard development, performance optimization, and production deployment.",
        ...
        "Utilized parameterization, dynamic measures, and advanced filtering techniques to enable self-service analytics and enhance user interactivity.",
        "Applied performance tuning strategies, including query folding, model optimization, and incremental refresh techniques to improve dashboard load times and scalability.",
